...
public class ShortestCommonAncestor {
    ...
    public ShortestCommonAncestor(Digraph G) {
        ...
        Topological test = new Topological(this.G.reverse());
    ...
    public int length(int v, int w) {
        ...
        lenancSearch(v, w, bfsv, bfsw);
        return length;
    }

    // Recursive search method for shortest length and ancestor
    private void lenancSearch(int v, int w, BreadthFirstDirectedPaths bfsv,
        ...
        for (int k : G.adj(v)) {
            ...
            if (k != root) lenancSearch(k, w, bfsv, bfsw);
        }
    }
